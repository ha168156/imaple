...
error_reporting(E_ALL); @ini_set('display_errors', true);
	$pages = array(
		'0'	=> array('id' => '1', 'alias' => array('en' => '回首页'), 'file' => '1.php'),
		'1'	=> array('id' => '4', 'alias' => array('en' => '关于速修'), 'file' => '4.php'),
		'2'	=> array('id' => '2', 'alias' => array('en' => '产品与服务'), 'file' => '2.php'),
		'3'	=> array('id' => '3', 'alias' => array('en' => '联络我们'), 'file' => '3.php')
	);
	$forms = array(
		'3'	=> array(
			'32a09f09' => Array( 'email' => '', 'subject' => 'Inquiry from the web page', 'sentMessage' => 'Form was sent.', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'fields' => array( array( 'fidx' => '0', 'name' => 'Name', 'type' => 'input', 'options' => '' ), array( 'fidx' => '1', 'name' => 'E-mail', 'type' => 'input', 'options' => '' ), array( 'fidx' => '2', 'name' => 'Message', 'type' => 'textarea', 'options' => '' ) ) )
		)
	);
	$langs = array(
		'en' => true
	...
	$base_url = '/';
	$user_domain = 'fleanet.zz.mu';
	$show_comments = false;
	include dirname(__FILE__).'/functions.inc.php';
	$home_page = '1';
	list($page_id, $lang) = parse_uri();
	$user_key = "f75pymRB3UxV+L9MqQ==";
	$user_hash = "0065a3803fda507f";
